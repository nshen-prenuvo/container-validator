...
def load_and_validate_images(flair_path, dwi_b1000_path, t2s_path, swi_path):
    """
...
def main():
    ...
    images, modality_names = load_and_validate_images(
        args.flair, args.dwi_b1000, args.t2s, args.swi
    )
