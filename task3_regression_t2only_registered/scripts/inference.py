...
def main():
    ...
    try:
        ...
        # Extract T2 predictions from properties
        t2_predictions_from_props = properties.get('t2_predictions')
        
        if t2_predictions_from_props is None:
        ...
        save_regression_results(t2_predictions_from_props, args.output)
        ...
        brain_age = t2_predictions_from_props[0, 0]
